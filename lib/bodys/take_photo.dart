...
class _TakePhotoState extends State<TakePhoto> {
  ...
  Future<void> processUpload() async {
    ...
    String nameImage = 'man2_${Random().nextInt(1000000)}.jpg';
    ...
    await Dio().post(pathApiUpload, data: formData).then((value)async {
      ...
      String pathApiInsertData = 'https://www.androidthai.in.th/egat/insertImageGho.php?isAdd=true&title=$title&urlImage=$urlImage';
      await Dio().get(pathApiInsertData).then((value) {
        MyDialog(context: context).normalDialog(title: 'Upload and Insert Success', subTitle: 'Success to Upload and Insert');
      });
    });
  }
}
